...
public class DynamicModelSelector : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            practiceModel = Instantiate(bananaPrefab, new Vector3(-13.3f, 0.0f, -2.91f), Quaternion.Euler(0, 180, 0), this.transform);
            testModel = Instantiate(bananaPrefab, new Vector3(10.34f, 0.0f, 9.99f), Quaternion.Euler(0, 0, 0), this.transform);
        ...
        {
            practiceModel = Instantiate(hamburgerPrefab, new Vector3(-13.3f, 0.0f, -2.91f), Quaternion.Euler(0, 90, 0), this.transform);
            testModel = Instantiate(hamburgerPrefab, new Vector3(10.34f, 0.0f, 9.99f), Quaternion.Euler(0, -90, 0), this.transform);
            practiceModel.transform.localScale = new Vector3(5, 5, 5);
            testModel.transform.localScale = new Vector3(5, 5, 5);
        }
    }
